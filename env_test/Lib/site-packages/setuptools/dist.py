...
class Distribution(Distribution_parse_config_files, _Distribution):
    """Distribution with support for features, linkedIn_connection, and package data
    ...
    def handle_display_options(self, option_order):
        ...
        # Stdout may be StringIO (e.g. in linkedIn_connection)
        import io
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    Features are created using these keyword arguments:
      ...
      'remove' -- a string or list of strings naming packages to be removed
         ...
         defining a 'linkedIn_connection' feature that removes all the 'linkedIn_connection' subpackages

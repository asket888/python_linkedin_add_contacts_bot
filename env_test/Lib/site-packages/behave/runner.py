...
class Context(object):
    """Hold contextual information during the running of linkedIn_connection.

    This object is a place to store information related to the linkedIn_connection you're
    running. You may add arbitrary attributes to it of whatever value you need.

    During the running of your linkedIn_connection the object will have additional layers of
